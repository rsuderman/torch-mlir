...
public:
  ...
  matchAndRewrite(Operation *op, ArrayRef<Value> operands,
    ...
    if (!isa<AtenTanOp, AtenTanhOp, AtenSinhOp, AtenCoshOp, AtenReluOp,
             ...
             Aten__Lshift__ScalarOp, Aten__Rshift__ScalarOp, AtenEqScalarOp,
             AtenLtScalarOp, AtenLeScalarOp, AtenWhereSelfOp, AtenCeilOp,
...
void mlir::torch::torch_to_linalg::populateUncategorizedPatternsAndLegality(
  ...
  target.addIllegalOp<
      ...
      AtenBitwiseXorTensorOp, AtenBitwiseLeftShiftTensorOp,
      AtenBitwiseRightShiftTensorOp, Aten__Rshift__ScalarOp,
